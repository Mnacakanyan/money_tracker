...
data class Currency(val code: String, val name: String, val isCrypto: Boolean = false) {
    companion object {
        fun getDefault() = Currency("USD", "US Dollar")
        fun getAvailable(): List<Currency> = listOf(
